...
def execute():
	"""Contract reset: apply a deterministic V1-like field order for Item.

	This fixes the earlier field_order patch logic by updating the active DocType-level
	Property Setter (commonly named like Item-main-field_order) instead of creating an
	unused record.
	"""
