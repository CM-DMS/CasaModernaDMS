...
def execute():
	"""Contract 18: move ERPNext Supplier Items table into low-priority purchase controls.

	Existing sites already have a deterministic Item `field_order` property setter.
	This patch updates that ordering so `supplier_items` is placed under
	...
	# Ensure Supplier Items table sits in the low-priority section.
